...
# sys.path.append(r"C:\Prism2\PythonLibs\Python3\PySide")                 #   FOR TESTING
...
class PrismWaitingIcon(QGraphicsView):
    ...
    def init_ui(self):
        ...
        self.imageUpdater.imageUpdated.connect(self.updateImage)
    ...
    def showWaitingIcon(self):
        print("in show")                #   TESTING
        self.show()
        self.update()

    def hideWaitingIcon(self):
        print("in hide")                #   TESTING
        self.hide()
